            ...
            <div className="z-10 flex w-full  flex-col items-center text-title font-bold uppercase text-accent-300  2xl:space-y-16 2xl:text-[10vw]">
                <div className="title 2xl:py-16">
                    ...
                    <h1
                        ...
                        className="translate-y-96 overflow-visible text-center"
                    >
                        Hey, I&apos;m Prajil
                    </h1>
                </div>
                <div className="title 2xl:py-16">
                    <h1
                        ...
                        className="font-outline-3 md:font-outline-4 translate-y-96 overflow-visible text-center text-transparent"
                    >
                        Hey, I&apos;m Prajil
                    </h1>
                </div>
                <div className=" title 2xl:py-16">
                    <h1
                        ...
                        className="translate-y-96 text-center"
                    >
                        Hey, I&apos;m Prajil
                    </h1>
                </div>
